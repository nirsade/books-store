...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var SearchForm = __webpack_require__(160);
	var PhotoContainer = __webpack_require__(161);
	var FlickrApi = __webpack_require__(162);
	    ...
	    render: function render() {
	        ...
	        function renderPhotoContainer() {
	            if (isLoading) {
	                ...
	                return React.createElement(PhotoContainer, { photos: photos });
	            }
	        }
	...
	var SearchForm = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'form',
	                { style: formStyle, onSubmit: this.onFormSubmit },
	                React.createElement('input', { style: inputStyle, type: 'text', ref: 'search', placeholder: 'Write Your Search' }),
	                React.createElement(
	                    'button',
	                    { style: buttonStyle },
	                    'Get Photos'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PhotoContainer = function PhotoContainer(_ref) {
	    ...
	    return React.createElement(
	        ...
	        photos.photo.map(function (object, i) {
	            ...
	            return React.createElement('img', { className: 'photo', src: a, key: i });
	        })
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    getPhotos: function getPhotos(search) {
